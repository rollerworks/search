...
{
    public static function assertKeysExists(array $input, array $required, string $path)
    {
    ...
    public static function assertOnlyKeys(array $input, array $accepted, string $path)
    {
