...
project = 'RollerworksSearch Doctrine ORM Documentation'
copyright = ''
...
html_short_title = 'RollerworksSearch Doctrine ORM'
...
latex_documents = [
  ('index', 'RollerworksSearch-Doctrine-ORM.tex', u'RollerworksSearch Doctrine ORM Documentation',
   u'Rollerworks', 'manual'),
]
...
man_pages = [
    ('index', 'RollerworksSearch Doctrine ORM', u'RollerworksSearch Doctrine ORM Documentation',
     [u'Rollerworks'], 1)
]
