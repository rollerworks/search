...
class SQLStructFactory extends AbstractSQLFactory
{
     ...
     * @api
     */
    public function getSQLStruct(FormatterInterface $formatter, DBConnection $DBConnection = null)
    {
        ...
        if (!class_exists($FQN, false)) {
            ...
            if ($this->autoGenerate) {
                $this->generateClass($formatter->BC, $entityNs, $this->annotationReader->getClassAnnotations(new \ReflectionClass($formatter->BC)), $this->classesDir);
            }
...
{
    public function __construct(FormatterInterface $formatter, $DBAL)
    {
