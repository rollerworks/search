    ...
    protected function generateValidations(array $annotations)
    {
        ...
        foreach ($annotations as $annotation) {
            ...
            if (!empty($filterType) && false === strpos($filterType, '\\')) {
                $filterType = '\\Rollerworks\\RecordFilterBundle\\Type\\' . ucfirst($filterType);
            }
            ...
            if (!empty($filterType)) {
                ...
                elseif ($annotation->hasParams()) {
                    ...
                    elseif (!$classReflection->implementsInterface('\\Rollerworks\\RecordFilterBundle\\FilterTypeInterface')) {
