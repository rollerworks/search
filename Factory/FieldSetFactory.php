...
class FieldSetFactory extends AbstractFactory
{
    ...
    private function generateType($type)
    {
        ...
        return sprintf('$typeFactory->newInstance(%s, %s)', var_export($type->getName(), true), var_export($type->getParams(), true));
    }
...
use Rollerworks\Bundle\RecordFilterBundle\BaseFieldSet;
