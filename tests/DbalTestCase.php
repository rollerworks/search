    ...
    public static function provideSimpleQueryTests()
    {
        return array(
            ...
            array(
                ...
                'SELECT i0_.id AS id0, i0_.label AS label1, i0_.pubdate AS pubdate2, i0_.status AS status3, i0_.customer AS customer4 FROM invoices i0_ INNER JOIN customers c1_ ON i0_.customer = c1_.id WHERE (((c1_.id IN (?) OR (c1_.id > ? AND c1_.id < ?))))',
                false,
                array('query' => 'SELECT I FROM Rollerworks\Component\Search\Tests\Fixtures\Entity\ECommerceInvoice I JOIN I.customer C WHERE '),
            ),
            array(
                ...
                array('invoice_customer_0' => array('integer', 20), 'invoice_customer_1' => array('integer', 2), 'invoice_customer_2' => array('integer', 10)),
                'SELECT i0_.id AS id0, i0_.label AS label1, i0_.pubdate AS pubdate2, i0_.status AS status3, i0_.customer AS customer4 FROM invoices i0_ INNER JOIN customers c1_ ON i0_.customer = c1_.id WHERE (((c1_.id NOT IN (?) AND c1_.id <> ? AND c1_.id <> ?)))',
                false,
                array('query' => 'SELECT I FROM Rollerworks\Component\Search\Tests\Fixtures\Entity\ECommerceInvoice I JOIN I.customer C WHERE '),
            ),
            array(
