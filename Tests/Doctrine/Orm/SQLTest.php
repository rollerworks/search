...
class SQLTest extends OrmTestCase
{
    ...
    public static function provideBasicsWithAliasTests()
    {
        return array(
            ...
            array('invoice_customer=2-5, 8;', '(I.customer IN(8) OR (I.customer BETWEEN 2 AND 5))'),
            array('invoice_customer=2-5,!8-10;', '(((I.customer BETWEEN 2 AND 5)) AND (I.customer NOT BETWEEN 8 AND 10))'),
            array('invoice_customer=2-5, !8;', '(((I.customer BETWEEN 2 AND 5)) AND I.customer NOT IN(8))'),
            array('invoice_customer=2-5, >8;', '((I.customer BETWEEN 2 AND 5) OR I.customer > 8)'),
    ...
    public static function provideWithQueryObjTests()
    {
        return array(
            ...
            array('invoice_customer=2-5, 8;', '(I.customer IN(:invoice_customer_0) OR (I.customer BETWEEN :invoice_customer_1 AND :invoice_customer_2))', array('invoice_customer_0' => 8, 'invoice_customer_1' => 2, 'invoice_customer_2' =>5)),
            ...
            array('invoice_customer=2-5, !8;', '(((I.customer BETWEEN :invoice_customer_0 AND :invoice_customer_1)) AND I.customer NOT IN(:invoice_customer_2))', array('invoice_customer_0' => 2, 'invoice_customer_1' => 5, 'invoice_customer_2' => 8)),
            array('invoice_customer=2-5, >8;', '((I.customer BETWEEN :invoice_customer_0 AND :invoice_customer_1) OR I.customer > :invoice_customer_2)', array('invoice_customer_0' => 2, 'invoice_customer_1' => 5, 'invoice_customer_2' => 8)),
    ...
    public static function provideFieldConversionTests()
    {
        return array(
            ...
            array('invoice_customer=2-5, 8;', '(CAST(customer AS customer_type) IN(8) OR (CAST(customer AS customer_type) BETWEEN 2 AND 5))'),
            ...
            array('invoice_customer=2-5, !8;', '(((CAST(customer AS customer_type) BETWEEN 2 AND 5)) AND CAST(customer AS customer_type) NOT IN(8))'),
            array('invoice_customer=2-5, >8;', '((CAST(customer AS customer_type) BETWEEN 2 AND 5) OR CAST(customer AS customer_type) > 8)'),
    ...
    public static function provideFieldConversionWithQueryObjTests()
    {
        return array(
            ...
            array('invoice_customer=2-5, !8;', "(((CAST(I.customer AS customer_type) BETWEEN :invoice_customer_0 AND :invoice_customer_1)) AND CAST(I.customer AS customer_type) NOT IN(:invoice_customer_2))", array('invoice_customer_0' => 2, 'invoice_customer_1' => 5, 'invoice_customer_2' => 8)),
            ...
            array('invoice_customer=2-5, 8;', "(CAST(I.customer AS customer_type) IN(:invoice_customer_0) OR (CAST(I.customer AS customer_type) BETWEEN :invoice_customer_1 AND :invoice_customer_2))", array('invoice_customer_0' => 8, 'invoice_customer_1' => 2, 'invoice_customer_2' => 5)),
            array('invoice_customer=2-5, >8;', "((CAST(I.customer AS customer_type) BETWEEN :invoice_customer_0 AND :invoice_customer_1) OR CAST(I.customer AS customer_type) > :invoice_customer_2)", array('invoice_customer_0' => 2, 'invoice_customer_1' => 5, 'invoice_customer_2' => 8)),
    ...
    public static function provideConversionStrategyTests()
    {
        return array(
            ...
            array('birthday=2; birthday="1990-05-30";', "(to_char('YYYY', age(birthday)) IN('2') OR birthday IN('1990-05-30'))"),
            array('birthday=2; birthday="1990-05-30",5;', "(to_char('YYYY', age(birthday)) IN('2', '5') OR birthday IN('1990-05-30'))"),
