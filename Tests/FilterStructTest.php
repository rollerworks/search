...
class FilterStructTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $struct = new FilterStruct('test', 'none', array(new SingleValue('4')));
    ...
    {
        $struct = new FilterStruct('test', 'none', array(), array(new SingleValue('4')));
    ...
    {
        $struct = new FilterStruct('test', 'none', array(0 => new SingleValue('4'), 4 => new SingleValue('4')), array(1 => new SingleValue('10'), 5 => new SingleValue('20')), array(2 => new Range(10, 100), 6 => new Range(110, 200)), array(3 => new Compare(10, '>'), 7 => new Compare(20, '<')));
    ...
    {
        $struct = new FilterStruct('test', 'none', array(0 => new SingleValue('4'), 4 => new SingleValue('4')), array(1 => new SingleValue('10'), 5 => new SingleValue('20')), array(2 => new Range(10, 100), 6 => new Range(110, 200)), array(3 => new Compare(10, '>'), 7 => new Compare(20, '<')), array(8 => new Range(12, 15)));
